...
<div class="w3-card-4 w3-white">
  ...
  <form id="formajax" class="w3-container" action="modreserva.php" method="POST">
    <p>      
	    <label class="w3-text-black"><b>Fecha inicio</b></label>
	    <input class="w3-input w3-border w3-light-gray" name="fechaini" type="datetime-local" value="<?php echo $_REQUEST['fechaini'] ?>" required>
	</p>
    <p>      
	    <label class="w3-text-black"><b>Fecha final</b></label>
	    <input class="w3-input w3-border w3-light-gray" name="fechafin" type="datetime-local" value="<?php echo $_REQUEST['fechafin'] ?>" required>
	</p>
    <p>
